    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="logForm" method="POST" action="<?=site_url('auth/login');?>">
                ...
                <input id="email" type="email" class="form-control" name="email" required placeholder="you@example.com">

                <label for="password">Password</label>
                <input id="password" type="password" class="form-control" name="password" minlength="8" required placeholder="Enter your password">

                <button type="submit" class="btn btn-primary">Login</button>

                <!-- Forgot password moved to bottom -->
